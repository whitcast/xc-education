 ...
 */
package com.xc.education.util.pay;
...
import com.xc.education.util.enums.DateFormatEnum;
import com.xc.education.util.enums.PayProductTypeEnum;
import com.xc.education.util.enums.PayTypeEnum;
import com.xc.education.util.tools.HttpUtil;
import com.xc.education.util.tools.JSONUtil;
import com.xc.education.util.tools.MD5Util;
...
public final class PayUtil {
	 ...
	 * xc支付
	 */
	public static String xcPay(String serialNumber, String productName, BigDecimal productPrice, Integer payType, String payKey, String paySecret, String payUrl, String notifyUrl) {
		...
		try {
			...
			logger.error("xc支付接口请求失败，resp={}", resp);
		}
		return "";
	}

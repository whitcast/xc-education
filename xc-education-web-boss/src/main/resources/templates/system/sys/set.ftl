    ...
    <form action="${base}/system/sys/updateSys" data-toggle="validate" method="post">
	    ...
	    <#if user.id == 1>
	        ...
	        <legend>支付通道信息</legend>
	            ...
	            <div class="form-group">
	                ...
	                <input type="text" name="payKey" value="<#if bean??>${bean.payKey!}</#if>" placeholder="xcKey" size="40">
	                <label class="control-label x150">paySecret：</label>
	                <input type="text" name="paySecret" value="<#if bean??>${bean.paySecret!}</#if>" placeholder="xcSecret" size="40">
	            </div>
	            <br />
	            <div class="form-group">
	    ...
	    <#else>
	        ...
	        <legend>支付通道信息</legend>
	            ...
	            <div class="form-group">
	                <label class="control-label x150">payKey：</label>
	                <input type="text" name="payKey" value="********" placeholder="xcKey" size="40">
	                <label class="control-label x150">paySecret：</label>
	                <input type="text" name="paySecret" value="********" placeholder="xcSecret" size="40">
	            </div>
	            <br />
	            <div class="form-group">
	            	<label class="control-label x150">支付请求：</label>

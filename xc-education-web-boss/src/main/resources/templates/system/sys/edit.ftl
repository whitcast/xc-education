...
<div class="bjui-pageContent">
	<form action="${base}/system/sys/update" data-toggle="validate" method="post">
		...
		<div class="form-group">
            <label class="control-label x85">xc_key：</label>
            <input type="text" name="xcKey" value="${bean.xcKey!}" placeholder="xc_key" size="20">
        </div>
		<div class="form-group">
            <label class="control-label x85">xc_secret：</label>
            <input type="text" name="xcSecret" value="${bean.xcSecret!}" placeholder="xc_secret" size="20">
        </div>
	</form>
</div>

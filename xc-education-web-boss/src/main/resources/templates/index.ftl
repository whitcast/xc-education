...
<link rel="icon" href="xc/images/favicon.ico" type="image/x-icon" />
...
<body>
	...
	<div id="bjui-window">
		...
		<footer id="bjui-footer">
			Copyright &copy; 2015 - <span id="y"></span>&nbsp;<a href="http://www.xc.net/" target="_blank">广州市领课网络科技有限公提供技术支持</a>

...
import com.xc.education.course.service.common.bo.OrderInfoCloseBO;
import com.xc.education.course.service.common.bo.auth.AuthOrderInfoContinuePayBO;
import com.xc.education.course.service.common.bo.auth.AuthOrderInfoForChartsBO;
import com.xc.education.course.service.common.bo.auth.AuthOrderInfoListBO;
import com.xc.education.course.service.common.bo.auth.AuthOrderInfoViewBO;
import com.xc.education.course.service.common.bo.auth.AuthOrderPayBO;
import com.xc.education.course.service.common.dto.auth.AuthOrderInfoDTO;
import com.xc.education.course.service.common.dto.auth.AuthOrderInfoLecturerIncomeDTO;
import com.xc.education.course.service.common.dto.auth.AuthOrderInfoListDTO;
import com.xc.education.course.service.common.dto.auth.AuthOrderInfoListForLecturerDTO;
import com.xc.education.course.service.common.dto.auth.AuthOrderPayDTO;
...
import com.xc.education.util.enums.IsShowEnum;
import com.xc.education.util.enums.IsShowUserEnum;
import com.xc.education.util.enums.OrderStatusEnum;
import com.xc.education.util.enums.StatusIdEnum;
import com.xc.education.util.enums.TradeTypeEnum;
import com.xc.education.util.pay.PayUtil;
import com.xc.education.util.tools.BeanUtil;
import com.xc.education.util.tools.DateUtil;
import com.xc.education.util.tools.NOUtil;
...
public class AuthApiOrderInfoBiz extends BaseBiz {
	...
	public Result<AuthOrderPayDTO> pay(AuthOrderPayBO authOrderPayBO) {
		...
		// 调用支付接口
		String payMessage = PayUtil.xcPay(String.valueOf(orderPay.getSerialNumber()), orderInfo.getCourseName(), orderInfo.getPricePaid(), orderInfo.getPayType(), sys.getPayKey(), sys.getPaySecret(), sys.getPayUrl(), sys.getNotifyUrl());
